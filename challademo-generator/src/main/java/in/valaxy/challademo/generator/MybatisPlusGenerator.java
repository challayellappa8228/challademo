...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "in.valaxy";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/challademo-model"),
        mapper("/challademo-dao"),
        mapperxml("/challademo-web"),
        service("/challademo-service"),
        web("/challademo-web"),
        ;
